---
description: Tutorial for setting up and running a steady 3D hydrodynamic simulation with Telemac3d using the standard SELAFIN (SLF) geometry format and QGIS pre-processing.
---
...
**The following descriptions refer to section 3 in the [Telemac3d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/raw/v9.0.0/documentation/telemac3d/user/telemac3d_user_9.0.pdf).**
...
### General Parameters
**The following descriptions refer to section 3.2 in the [Telemac3d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/raw/v9.0.0/documentation/telemac3d/user/telemac3d_user_9.0.pdf).**
...
**The following descriptions refer to section 6 in the [Telemac3d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/raw/v9.0.0/documentation/telemac3d/user/telemac3d_user_9.0.pdf).**
...
* `1` enables upwinding with the classical SUPG scheme (default; recommended when the {term}`CFL` condition is unknown), and
...
Read more in section 6.2.2 of the [Telemac3d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/raw/v9.0.0/documentation/telemac3d/user/telemac3d_user_9.0.pdf).
...
**The following descriptions refer to section 4.1 in the [Telemac3d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/raw/v9.0.0/documentation/telemac3d/user/telemac3d_user_9.0.pdf).**
...
:class: tip
For unsteady simulations (time-variable inflow/outflow rates), pre-define the thickness of vertical layers with the `ZSTAR` parameter in a user Fortran file (subroutine) as described in section 4.1 of the [Telemac3d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/raw/v9.0.0/documentation/telemac3d/user/telemac3d_user_9.0.pdf). Read more about setting up an unsteady simulation with TELEMAC in the {ref}`Telemac2d unsteady tutorial <chpt-unsteady>`.
```
...
**The following descriptions refer to section 4.2 in the [Telemac3d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/raw/v9.0.0/documentation/telemac3d/user/telemac3d_user_9.0.pdf).**
...
Read more about options for defining velocity profiles in section 4.3.12 of the [Telemac3d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/raw/v9.0.0/documentation/telemac3d/user/telemac3d_user_9.0.pdf).
...
**The following descriptions refer to section 5.2 in the [Telemac3d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/raw/v9.0.0/documentation/telemac3d/user/telemac3d_user_9.0.pdf).**

The fundamental principles of turbulence and its application to the {term}`Navier-Stokes equations` are explained in the {ref}`steady Telemac2d tutorial <tm2d-turbulence>`. In 3d, TELEMAC developers recommend the $k-\epsilon$ model (`3`) for most river applications. The following model numbers are available for both `HORIZONTAL TURBULENCE MODEL` and `VERTICAL TURBULENCE MODEL`:
...
The steering file uses the $k-\epsilon$ model for both horizontal and vertical directions:
