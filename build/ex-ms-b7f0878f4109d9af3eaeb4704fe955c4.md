---
description: Python exercise for 1D open-channel hydraulics using the Manning-Strickler formula, implementing loops and functions to compute stage-discharge relationships.
---
...
The backward solution to the *Manning-Strickler* formula is a non-linear problem if the channel is not rectangular. This is why an iterative approximation is needed and here, we use the *Newton-Raphson* scheme {cite:p}`akanbi_model_1987` for this purpose (see also the [the University of Stuttgart's ILIAS platform](https://ilias3.uni-stuttgart.de)).
