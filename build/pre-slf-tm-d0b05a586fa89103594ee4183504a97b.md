---
description: Pre-processing tutorial for TELEMAC using QGIS and BlueKenue to generate a SELAFIN (SLF) computational mesh from a Digital Elevation Model (DEM) for hydrodynamic simulations.
---
