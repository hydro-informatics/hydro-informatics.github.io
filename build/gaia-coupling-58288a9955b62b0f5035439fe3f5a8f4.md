---
description: Introduction to coupling TELEMAC hydrodynamics with GAIA morphodynamics for simulating bedload and suspended sediment transport in rivers, lakes, and estuaries.
---
...
* TELEMAC v9.0.0 ({ref}`stand-alone installation <modular-install>`) - earlier versions may not recognize some of the keywords used in this eBook.
