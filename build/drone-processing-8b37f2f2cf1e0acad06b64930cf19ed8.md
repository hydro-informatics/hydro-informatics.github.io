---
description: Tutorial for processing drone (UAV) aerial imagery with Agisoft Metashape to create Digital Elevation Models (DEMs) and orthoimagery for river and terrain surveys.
---
