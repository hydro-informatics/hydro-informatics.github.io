---
description: Hydrodynamic numerical simulations with Telemac2d
---
...
**The following descriptions refer to section 7.1 in the [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf).**

Telemac2d comes with three solvers for approximating the depth-averaged {term}`Navier-Stokes equations` (i.e., the {term}`Shallow water equations`) {cite:p}`kundu_fluid_2008` (p. 262) that can be chosen by adding the **EQUATIONS** keyword to the `*.cas` file:
...
**The following descriptions refer to section 7.2.1 in the [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf).**
...
The [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf) state that the following scalar **SCHEME FOR ADVECTION** keywords apply instead of the soon deprecated TYPE OF ADVECTION list:
...
:class: tip
The [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf) recommend specific combinations depending on the simulation scenario.
...
The finite volume method is mentioned here for completeness and detailed descriptions are available in section 7.2.2 of the [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf), and the malpasset example (`telemac/v9.0.0/examples/telemac2d/malpasset/`). To activate the finite volume scheme use:
...
**The following descriptions refer to section 7.3.1 in the [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf).**
...
The solver options vary between values of **`2` for a small mesh** and **`5` for a large mesh**. Integers of `3` or `4` can be used for medium-sized meshes. The [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf) recommends running simulations multiple times for finding an optimum value, where higher values (close to `5`) increase the time required for an iteration but lead to faster convergence.

(tm2d-accuracy)=
### Numerical Accuracy

**The following descriptions refer to section 7.3.2 in the [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf).**
...
**The following descriptions refer to section 7.5 in the [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf).**
...
Read more about viable or trouble-making parameter combinations for tidal flats in section 16.5 in the [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf).
````

### Matrix Handling

**The following descriptions refer to section 7.6 in the [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf).**
...
**The following descriptions of friction parameters refer to section 4.2 in the [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf).**
...
**The following descriptions refer to section 4.1 in the [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf).**
...
* `TPXO SATELLITE ALTIMETRY` initializes the model using information provided by a user-defined database (e.g., the [OSU TPXO model for ocean tides](http://g.hyyb.org/archive/Tide/TPXO/TPXO_WEB/global.html)). Read more in section 4.2.12 of the [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf) on modeling marine systems.
...
**The following descriptions of friction parameters refer to section 6.1 in the [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf).**

The **LAW OF BOTTOM FRICTION** keyword defines a roughness model for topographic boundaries, which can be set to:
...
**The following descriptions refer to section 6.2 in the [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf).**
