---
description: Introduction to open TELEMAC-MASCARET for 2D and 3D hydro-morphodynamic river simulation, with a guide to all tutorials covering pre-processing, steady flow, unsteady flow, and GAIA sediment transport.
---
...
* Restart / reference (for model validation) file
  ...
  + More information in the [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf) (section 4.1.3) (see also {cite:t}`hervouet_user_2014`).
...
The [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf) (section 4.1.3) provide more explanations on the usage of results/restart files (e.g., for speeding up simulations).
