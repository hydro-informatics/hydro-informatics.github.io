---
description: Beginner QGIS tutorial with video guidance for loading, visualizing, and analyzing geospatial data including shapefiles and rasters for water resources engineering.
---
...
```{hint}
All files created in this tutorial can be downloaded from the [QGIS tutorial repository](https://github.com/Ecohydraulics/qgis-tutorial).
```
