---
description: Python exercise for building a graphical user interface (GUI) with tkinter that wraps a sediment transport module, combining object-oriented programming with NumPy and pandas.
---
