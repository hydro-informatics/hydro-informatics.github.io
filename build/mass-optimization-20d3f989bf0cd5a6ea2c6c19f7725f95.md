---
description: Workflow and best practices for achieving mass conservation in TELEMAC river models, covering boundary condition setup, dry initialization, and stage-discharge relation calibration.
---
...
Read more about the finite volume scheme in section 7.2.2 of the [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf), and the malpasset example (`telemac/v9.0.0/examples/malpasset/`).
