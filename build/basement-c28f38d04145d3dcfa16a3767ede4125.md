---
description: Complete tutorial for setting up and running 2D hydrodynamic numerical simulations with BASEMENT (ETH Zurich), covering BASEHPC model setup, steady-state modeling, and result visualization.
---
