---
description: Introduction to Python programming for hydraulics and eco-morphodynamics engineers, covering JupyterLab, Binder, and Google Colab for running interactive Python notebooks.
---
