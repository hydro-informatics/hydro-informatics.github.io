---
description: Guide to geospatial software for water resources engineering including QGIS installation and usage on Windows, Linux, and macOS for GIS data visualization and analysis.
---
...
:class: attention
ArcGIS is designed for Windows and will not run on macOS or Linux. In addition, a license needs to be purchased.
```
