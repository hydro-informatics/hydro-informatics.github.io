---
description: TELEMAC model optimization guide covering computational speed improvements, physical correctness calibration, mass conservation, and machine learning-assisted model refinement.
---
...
The [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf) provides more recommendations for computing time, stability, and model optimization, including the mesh, in section 16.
```
...
*This section is co-authored by [Federica Scolari](https://www.iws.uni-stuttgart.de/institut/team/Scolari/)*.
