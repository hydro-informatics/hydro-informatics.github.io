---
description: Overview of Python IDEs and APIs for water resources engineering, including PyCharm, JupyterLab, and Anaconda, with guidance on choosing the right development environment.
---
...
If the command fails, try either `jupyter-lab` or start Jupyter notebook by typing `jupyter notebook`. The *Jupyter Notebook* application will open in the default web browser.
