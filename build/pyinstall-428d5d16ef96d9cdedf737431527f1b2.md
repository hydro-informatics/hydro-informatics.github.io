---
description: Cross-platform Python installation guide using conda, mamba, pip, and venv, with instructions for setting up reproducible environments for geospatial and scientific computing.
---
