---
description: Tutorial for running OpenFOAM multiphase flow case setup.
---
...
Different patch types are available in OpenFOAM. For a detailed explanation refer to the [boundaries](https://www.openfoam.com/documentation/user-guide/4-mesh-generation-and-conversion/4.2-boundaries) section of the [OpenFOAM User Guide](https://doc.cfd.direct/openfoam/user-guide/). 
