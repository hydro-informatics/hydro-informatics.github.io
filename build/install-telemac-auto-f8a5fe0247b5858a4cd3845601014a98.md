---
description: Step-by-step tutorial for automatic installation of open TELEMAC-MASCARET on Debian Linux and Ubuntu-based systems using installer scripts.
---
...
TELEMAC reads and writes `.med` meshes through its HERMES layer, which is compiled against the **system MED libraries** (the `libmedc-dev` / `libmed-dev` / `libmedimport-dev` packages) - **not** against the MED libraries bundled inside SALOME. SALOME ships its own MED built with a different ABI (64-bit `med_int` and a different HDF5 build), and linking or loading it together with TELEMAC triggers `size of symbol 'med_' changed` link warnings and the runtime error `HERMES_WRONG_MED_FORMAT_ERR`.
...
* Debian 12 users download:
  * [telemac_debian12_installer.sh](https://raw.githubusercontent.com/Ecohydraulics/numerical-software-installers/main/debian12/telemac_debian12_installer.sh) and save it in the ROOT directory.
  * [systel.debian12.cfg](https://raw.githubusercontent.com/Ecohydraulics/numerical-software-installers/main/debian12/systel.debian12.cfg) and save it in the ROOT directory.
  * [pysource.debian12.sh](https://raw.githubusercontent.com/Ecohydraulics/numerical-software-installers/main/debian12/pysource.debian12.sh) and save it in the ROOT directory.
* Mint 22 / Ubuntu 24 users download:
  * [telemac_ubuntu24_installer.sh](https://raw.githubusercontent.com/Ecohydraulics/numerical-software-installers/main/ubuntu24-mint22/telemac_ubuntu24_installer.sh) and save it in the ROOT directory.
  * [systel.mint22.cfg](https://raw.githubusercontent.com/Ecohydraulics/numerical-software-installers/main/ubuntu24-mint22/systel.mint22.cfg) and save it in the ROOT directory.
  * [pysource.mint22.sh](https://raw.githubusercontent.com/Ecohydraulics/numerical-software-installers/main/ubuntu24-mint22/pysource.mint22.sh) and save it in the ROOT directory.

Make sure all files are in the same (ROOT installation) directory on your computer.
