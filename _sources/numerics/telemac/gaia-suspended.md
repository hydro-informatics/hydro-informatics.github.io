...
This behavior is automatic in Gaia when multiple sediment classes with different grain sizes are defined. Read more about sand-mud mixtures in section 4 of the {{ gaia }}.
```
...
Read more about the definition of numerical parameters in section 2.1.5 in the {{ gaia }}.
