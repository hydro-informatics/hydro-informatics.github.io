...
* Um später die Abgrenzung bestimmter Regionen des Flussökosystems zu erleichtern, fügen Sie unter {term}`DEM` ein {ref}`satellite imagery basemap <basemap>` (XYZ-Kachel) hinzu und passen Sie die Ebenensymbologie an.
