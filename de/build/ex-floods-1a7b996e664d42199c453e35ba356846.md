...
1. **Äkohydraulische Erzeugnisse*: Insbesondere in trockenen Gebieten ist es wichtig zu wissen, wie lange bestimmte Entladungen unter bestimmten Ebenen liegen, wo viele aquatische Lebensräume nicht tief genug, zu heiß oder vom Hauptkanal getrennt sein können. Daher wollen wir die **-Exceedance-Wahrscheinlichkeit** einer gegebenen Entladung kennen.
...
* Die **-Exzessionswahrscheinlichkeit** ist die Wahrscheinlichkeit eines Ereignisses einer bestimmten Größe (in m$^3$/s oder CFS) oder höher.
...
* Flussdatensätze aus alpinen und mittleren Flüssen werden vom Eidgenössischen Bundesamt für die [hydrologische Datenplattform](https://www.hydrodaten.admin.ch/) (für langfristige Beobachtungen muss auch hier ein Formular ausgefüllt werden).
