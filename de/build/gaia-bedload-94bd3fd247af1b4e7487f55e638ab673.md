...
$$
\Phi b = \begin{cases} 0 & \mbox{ if } \tau {x,cr} > \tau {x} \\f {mpm} \cdot (\tau {x} - \tau {x,cr})^{3/2} & \mbox{ if } \tau {x,cr} \leq \tau {x,cr}\end{cases}
$$ (eq-mpm)
...
$$
\Phi b = \frac{0.053}{D {x}^{0.3}} \cdot \left(\frac{\tau {x} - \tau {x,cr}{\tau {x,cr}{x,cr}{x,cr}{x,cr}{x,cr}{x,cr}\tau {x,cr}\richtig\cr}^{2.1}
$$ (eq-rijn)
