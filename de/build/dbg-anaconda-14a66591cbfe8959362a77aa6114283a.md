...
* Konfliktlösung aktiviert:
	- Warten, bis Konflikte parsed (und gelöst)
	- `conda update conda`
...
* Fehlerbehebung durch Löschen des `.continuum`-Verzeichnis:
...
* Reinstallieren Sie *Anaconda Navigator* von *Anaconda Prompt* (oder *Linux* / *macOS* *Terminal*) durch Laufen:
	- `conda remove anaconda-navigator`
	- `conda install anaconda-navigator`
* *Anaconda Navigator* Konfiguration aus *Anaconda Prompt* (oder *Linux* / *macOS* *Terminal*) mit `anaconda-navigator --reset` (Beachtung: das kann destruktiv sein).
...
* Reinstallieren Sie *PyQt5* von *Anaconda Prompt* (oder *Linux* / *macOS* *Terminal*):
	- `pip uninstall PyQt5`
	- `pip install PyQt5`
...
* Clean tarballs eine unnötige Paketinstallationsdateien mit *Anaconda Prompt* oder *Linux* / *macOS* *Terminal*:
    + Aggressive Aufräumung: `conda clean --all` (weitere Informationen finden Sie unter [developer's docs](https://docs.conda.io/projects/conda/en/latest/commands/clean.html)).
