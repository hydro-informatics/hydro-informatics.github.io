...
1. Use the following keywords to prescribe roughness coefficients at the boundaries that correspond to **measured {term}`Wasserstands-Abfluss Beziehung <Stage-discharge relation>`** and back-calculated cross-section averaged hydraulics:
