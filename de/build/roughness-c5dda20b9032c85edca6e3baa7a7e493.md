---
description: Define spatially distributed friction and roughness zones in TELEMAC2d using QGIS and BlueKenue, assigning Manning or Strickler coefficients to different riverbed material types.
---
...
Appendix E of the [Telemac2d manual](https://gitlab.pam-retd.fr/otm/telemac-mascaret/-/blob/v9.0.0/documentation/telemac2d/user/telemac2d_user_9.0.pdf) provides more explanations on the tabular parameters (e.g., `typeB`, `rB`, or `nDefB`), and the friction laws (e.g., STRI, NIKU) are explained in more detail in this eBook in the steady-2d {ref}`section on friction <tm2d-friction>`. 
```
