...
* Geographical, atlas-style map data werden von [naturalearthdata.com](https://www.naturalearthdata.com) (z.B. die ~230 MB [Natural Earth quick start kit](https://www.naturalearthdata.com/downloads/)gebündelt mit vorgefertigten QGIS-Projekten) bereitgestellt.
* {term}`DEM`s, ozeanographische und mehr wasserbezogene Karten sind in den USA erhältlich [NOAA Geo-platform](https://noaa.maps.arcgis.com/home/search.html?q=owner%3Ancei_noaa&t=content&start=1&sortOrder=desc&sortField=modified&focus=layers) und dessen [TDS Catalog](https://www.ncei.noaa.gov/thredds/catalog/catalog.html)
...
* Satellitenbilder sind verfügbar bei
    - [USGS' Earth Explorer](https://earthexplorer.usgs.gov/)
    - das [ESA's Copernicus Data Space Ecosystem](https://dataspace.copernicus.eu/) (Sentinel-1/2/3/5P; dies ersetzte den ehemaligen Copernicus Open Access Hub / *SciHub*, der am 2. November 2023 stillgelegt wurde)
...
* Climatologische Daten werden von [NASA Earth Observations (NEO)](https://neo.gsfc.nasa.gov/).
* Meteorologische (z.B. Temperatur oder Niederschlag) und Echtzeit-Satellitendaten stehen unter [wunderground.com](https://www.wunderground.com/) und dessen [wundermap](https://www.wunderground.com/wundermap).
* Klima- und meteorologische Daten und Prognosen sind unter [cds.climate.copernicus.eu](https://cds.climate.copernicus.eu), einschließlich z.B. ERA5 monatlich gemittelte Temperaturdaten
* Daten zur Landnutzung (einschließlich Baldachinabdeckung), sozioökonomische Merkmale und globaler Wandel sind auf dem [FAO Map Catalog (GeoNetwork)](https://data.apps.fao.org/map/catalog/srv/eng/catalog.search) oder dem archivierten ISCGM Global Map Portal ([go to their GitHub archive](https://globalmaps.github.io/)) verfügbar.
