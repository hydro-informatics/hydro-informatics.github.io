...
Die Ähnlichkeit des einheitlichen Sedimenttransports (d.h. pro Einheitsbreite) kann anhand der Skala $\lambda_{q_b}$ verifiziert werden, die von {term}`Exner equation` abgeleitet wird:
