---
description: Python exercise for flood frequency analysis and return period calculation using pandas, covering exceedance probability and recurrence intervals for hydrological discharge data.
---
