...
Pour les premiers utilisateurs, `d3d4-suite` reste l'essai préféré car c'est la cible de niveau suite associée à Delft3D 4. La plus petite cible `flow2d3d` est plus appropriée après que la chaîne d'outils hôte ait déjà été montrée pour fonctionner.
