...
* Quelles sont les dépendances du logiciel ou du projet (p. ex. autres paquets *Python* tels que {ref}`numpy`)?
...
* Réparation : étapes pour dépanner une erreur.
...
- Évitez le formatage du même genre de chose redondant (et incohérent)
