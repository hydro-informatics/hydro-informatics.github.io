...
## Terminologie
Une simulation hydromorphodynamique implique la modélisation de processus axés sur le ruissellement **{term}`Sediment transport`**. Les sections précédentes de ce livre électronique portent sur l'hydrodynamique définie comme *l'étude des liquides en mouvement* et la présente section porte sur **morphodynamique** définie comme **l'étude des changements liés au temps dans les formes des lits alluviaux et leurs processus sous-jacents**.
...
* Les définitions des limites sous la forme de [boundarys.cli](https://github.com/hydro-informatics/telemac/raw/main/gaia2d-tutorial/boundaries.cli).
...
* Le nouveau [gaia-morphodynamique.cas](https://github.com/hydro-informatics/telemac/raw/main/gaia2d-tutorial/gaia-morphodynamics.cas) dossier de pilotage.
