...
Pour utiliser des lettres grecques dans le texte en ligne, utilisez la langue *html*, où `&lettername;` produit le symbole de la lettre souhaitée *Greek* (par exemple, tapez `&delta;` à sortie &delta; ou `&Delta;` pour produire une lettre majuscule &Delta;). Le tableau suivant donne un aperçu des symboles grecs.
