...
- `hec_file` pour activer la sélection d'un cahier de travail défini par l'utilisateur pour la sortie *HEC-RAS*.
...
1. Un manuel de sortie *HEC-RAS* (`xlsx`)
1. Un répertoire de sortie où le manuel `bed_load_mpm.xlsx` sera stocké.
