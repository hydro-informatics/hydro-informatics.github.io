...
Les descriptions des paquets open source pour le traitement des données géospatiales s'appuient sur les explications de [Michael Diener's Python Geospatial Analysis Cookbook](https://github.com/mdiener21/python-geospatial-analysis-cookbook) (accès ouvert sous licence MIT). Par conséquent, si vous voulez en savoir plus sur toute information fournie ici, jetez un oeil à ce livre électronique complet.
