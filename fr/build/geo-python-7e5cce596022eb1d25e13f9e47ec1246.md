---
description: Introduction to geospatial Python programming for hydrology, covering open-source and commercial libraries, raster and vector data manipulation, and geospatial file format conversion.
---
...
* Use the [flusstools](https://flusstools.readthedocs.io) package to facilitate working with the tutorials provided with this eBook.
