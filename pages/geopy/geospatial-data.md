...
* Data on land use (including canopy cover), socio-economic characteristics, and global change are available at the [FAO GeoNetwork](http://www.fao.org/geonetwork/srv/en/main.home) or the archived ISCGM Global Map portal ([got to their github archive](https://globalmaps.github.io/)).
...
* (Poly) lines consisting of lines defined by start and end points.
